/** Caminhos em `public/images` — cada arquivo usado no máximo uma vez; sobras para futuras trocas. */
export const siteImages = {
  /** Hero: mesa de frios, figos e uvas — impacto gastronômico */
  ...
  differentials: "/images/Encomendas especiais/DSCF9962.jpg",
  /** Depoimento: evento ao ar livre — alinhado ao casamento citado */
  testimonial: "/images/Casamento/WhatsApp Image 2026-03-24 at 11.24.46.jpeg",
  /** Contato: torta salgada em pedestal — convite à proposta personalizada */
  contact: "/images/Encomendas especiais/DSCF1753.jpg",
} as const
